...
NH11 <- readRDS("C:/Users/Naksh/Desktop/R Project/DS-Foundation/logistic_regression/logistic_regression/dataSets/NatHealth2011.rds")
...
predict(hyp.out, type = "response",se.fit = TRUE, interval="confidence", newdata = predDat)
...
ever.wrk<-glm(everwrk~r_maritl+age_p,data = NH11,family = "binomial")
summary(ever.wrk)
